...
$inbam1=$para{"i"};
if(defined $para{"j"}){if($para{"j"} ne ""){$inbam2=$para{"j"};}}
$type=$para{"t"};
$producecircosplot=$para{"ch"};
$hp=$para{"hp"};
$ha=$para{"ha"};
$depth=$para{"d"};
$isall=$para{"A"};
...
$sa=$para{"sa"};
$cs=$para{"cs"};
if(defined $para{"L"}){if($para{"L"}){$regionbed=$para{"L"};}}
$inref=$para{"r"};
$outref=$para{"R"};
$qc=$para{"QC"};
$str=$para{"str"};
$strflagmentsize=$para{"strf"};
$A=$para{"alpha"};
$B=$para{"beta"};
$bwa=$para{"bwa"};
if(defined $para{"bwaindex"}){if($para{"bwaindex"} ne ""){$bwaindex=$para{"bwaindex"};}}
$samtools=$para{"samtools"};
$advance=$para{"advance"};
if(exists $para{"h"}){$help=$para{"h"};}
